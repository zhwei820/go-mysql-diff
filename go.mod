...
require (
	...
	github.com/zhwei820/generic_tool v0.0.0-20230313101600-6b2b6ae7aede
	github.com/zhwei820/log v0.0.6
...
require (
	...
	github.com/zhwei820/sentry-grpc v0.0.0-20230324162622-50a64053ab25 // indirect
